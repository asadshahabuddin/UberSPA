...
app.controller("UberSPController", function(GlobalService, $scope, $q)
{
    ...
    var initGoogleMaps = function()
    {
        ...
        google.maps.event.addListener(orgnAddrBox, "places_changed", function()
        {
            ...
            $scope.group("chicago", orgnCoords.G, orgnCoords.K);
        });        
    ...
    var currentPositionFailureCallback = function(err)
    {
        if(err)
        {
            ...
            var content = "The City of Chicago."
        }
        else
        {
        ...
        var mapOptions = {
            content : content,
            map     : map,
            position: new google.maps.LatLng(41.8604376, -87.6697496)
        };
