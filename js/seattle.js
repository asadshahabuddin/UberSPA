...
app.controller("UberSPController", function($scope, GlobalService, $q)
{
    ...
    var initGoogleMaps = function()
    {
        ...
        google.maps.event.addListener(orgnAddrBox, "places_changed", function()
        {
            ...
            $scope.group("seattle", orgnCoords.G, orgnCoords.K);
        });        
    ...
    var currentPositionFailureCallback = function(err)
    {
        if(err)
        {
            ...
            var content = "The City of Seattle."
        }
        else
        {
        ...
        var mapOptions = {
            content : content,
            map     : map,
            position: new google.maps.LatLng(47.6152531, -122.3223446)
        };
